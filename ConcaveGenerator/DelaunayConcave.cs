...
{ 
    public class DelaunayConcave
    {
        ...
        public class DelaunayMesh2d
        {
            ...
            private void SetEdge(Triangle t, int i)
            {
                if (t.P0Index < t.P1Index)
                {
                    ...
                    Edges[t.P0Index, t.P1Index].Length = BallConcave.Distance(Points[t.P0Index], Points[t.P1Index]);
                }
                else
                {
                    ...
                    Edges[t.P1Index, t.P0Index].Length = BallConcave.Distance(Points[t.P0Index], Points[t.P1Index]);
                }
                ...
                if (t.P1Index < t.P2Index)
                {
                    ...
                    Edges[t.P1Index, t.P2Index].Length = BallConcave.Distance(Points[t.P1Index], Points[t.P2Index]);
                }
                else
                {
                    ...
                    Edges[t.P2Index, t.P1Index].Length = BallConcave.Distance(Points[t.P1Index], Points[t.P2Index]);
                }
                ...
                if (t.P0Index < t.P2Index)
                {
                    ...
                    Edges[t.P0Index, t.P2Index].Length = BallConcave.Distance(Points[t.P0Index], Points[t.P2Index]);
                }
                else
                {
                    ...
                    Edges[t.P2Index, t.P0Index].Length = BallConcave.Distance(Points[t.P0Index], Points[t.P2Index]);
                }
            }
        ...
        public class DelaunayTriangluation
        {
        ...
        {
            DelaunayTriangluation del = new DelaunayTriangluation();
